...
Standalone app generates start entry point (no module alias needed)
  $ ofpp to-ml --topologies UnixHello $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
All standalone topologies generate start call
  ...
  >   ofpp to-ml --topologies "$t" $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
KV topology wires static store via functor
  $ ofpp to-ml --topologies UnixKvRo $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
Socket stack topologies use params for connect args
  $ ofpp to-ml --topologies UnixNetwork $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
Dhcp topology uses Netif with positional device param
  $ ofpp to-ml --topologies UnixDhcp $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
Ping6 topology wires Ethernet and IPv6 functors
  $ ofpp to-ml --topologies UnixPing6 $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
Conduit topology uses adapter with start method
  $ ofpp to-ml --topologies UnixConduit $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
DNS topology uses adapter with start method for tuple unpacking
  $ ofpp to-ml --topologies UnixDns $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
...
DirectNetwork imports TcpipStack and generates 11 functor applications
  $ ofpp to-ml --topologies DirectNetwork $F/types.fpp $F/devices.fpp $F/stacks.fpp $F/applications.fpp 2>/dev/null
