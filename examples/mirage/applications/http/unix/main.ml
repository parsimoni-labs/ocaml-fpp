...
module Paf_server = Paf_mirage.Server
...
module Unikernel = Unikernel.Make(Certs_data)(Keys_data)(Paf_server)
...
let start = lazy (
  ...
  let* paf_server = Paf_server.connect () in
  Unikernel.start certs_data keys_data paf_server)
