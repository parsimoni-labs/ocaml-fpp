...
let alpn_0 = Mirage_runtime.register_arg @@ Unikernel.alpn
...
module Mimic_happy_eyeballs = Mimic_happy_eyeballs.Make(Stackv4v6)(Happy_eyeballs_mirage)(Dns_client)
...
let start = lazy (
  ...
  Unikernel.start ~tls:(tls_0 ()) ~tls_port:(tls_port_0 ()) ~alpn:(alpn_0 ()) certs_data keys_data tcpv4v6_socket connect http_server)
