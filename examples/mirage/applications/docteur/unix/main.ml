...
(* Generated by ofpp to-ml from topology UnixDocteur *)
let filename_0 = Mirage_runtime.register_arg @@ Unikernel.filename
...
let start = lazy (
  ...
  Unikernel.start ~filename:(filename_0 ()) static_t)
...
let () =
  let t =
    ...
    let* () = Lwt.return (Mirage_runtime.(with_argv (runtime_args ()) "UnixDocteur" (Mirage_bootvar.argv ()))) in
    ...
    Mirage_runtime.set_name "UnixDocteur";
