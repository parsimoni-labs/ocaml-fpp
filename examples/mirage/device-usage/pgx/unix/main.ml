...
(* Generated by ofpp to-ml from topology UnixPgx *)
...
let () =
  let t =
    ...
    let* () = Lwt.return (Mirage_runtime.(with_argv (runtime_args ()) "UnixPgx" (Mirage_bootvar.argv ()))) in
    ...
    Mirage_runtime.set_name "UnixPgx";
