...
(* Generated by ofpp to-ml from topology UnixHeads2 *)
...
let () =
  let t =
    ...
    let* () = Lwt.return (Mirage_runtime.(with_argv (runtime_args ()) "UnixHeads2" (Mirage_bootvar.argv ()))) in
    ...
    Mirage_runtime.set_name "UnixHeads2";
